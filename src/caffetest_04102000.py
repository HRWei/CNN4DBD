...
def Lenet(xz_img_list,yz_img_list,batch_size,include_acc=False):
    ...
    concat1=L.Concat(data1,data2)
    conv1=L.Convolution(concat1, kernel_size=5, stride=1,num_output=6, pad=0,weight_filler=dict(type='xavier'))
    ...
    fc3=L.InnerProduct(pool2, num_output=200,weight_filler=dict(type='xavier'))
